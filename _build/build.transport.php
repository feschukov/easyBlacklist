...
if (!empty($_GET['download'])) {
	...
	$modx->log(modX::LOG_LEVEL_INFO, "Done! You can download the package: <a href=\"" . MODX_BASE_URL . "core/packages/" . $signature . ".transport.zip\">/core/packages/" . $signature . ".transport.zip</a>");
}
