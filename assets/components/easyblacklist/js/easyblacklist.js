...
easyBlacklist.utils.renderActions = function (value, props, row) {
	var res = [];
	...
	return String.format(
		'<ul class="easyblacklist-row-actions">{0}</ul>',
		res.join('')
	);
};

easyBlacklist.utils.getMenu = function (actions, grid, selected) {
	var menu = [];
...
easyBlacklist.utils.renderBoolean = function (value, props, row) {
	return value
